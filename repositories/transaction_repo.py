# crediflux/repositories/transaction_repo.py
...
class TransactionRepo:
    @staticmethod
    def save(user_id: int, description: str, amount: float,
             paid_to: str, group_id: Optional[int] = None) -> bool:
        conn, cur = get_db()
        try:
            cur.execute(
                """INSERT INTO transactions (user_id, group_id, description, amount, paid_to)
                   VALUES (%s,%s,%s,%s,%s)""",
